module mt95F4  !!DANI !!grd --> grd
   implicit none; 
   public  :: grd_init, grd_int32, grd_real2; 
   private :: uiadd, uimlt, init_by_scalar, next_state; 
   private :: grd_int32_0d, grd_real2_0d; 
  ...
  real(kind=wr), private, parameter:: p231 = 2147483648.0_wr, p232 = 4294967296.0_wr, p232_1 = p232 - 1.0_wr, pi232 = 1.0_wr/p232, &
      ...
      & pi253 = 1.0_wr/9007199254740992.0_wr, p231d232_1 = p231/p232_1, &
      p231_5d232 = (p231 + 0.5_wr)/p232
   integer(kind=wi), private, parameter:: alps = 62_wi, clen = (n + 1_wi)*7_wi
   type, public :: grd_state; private; logical(kind=wi) :: ini = .false._wi; 
   ...
   type(grd_state), private, save  :: state; 
   interface grd_init; module procedure init_by_scalar; end interface grd_init
...
contains; 
   elemental function uiadd(a, b) result(c); intrinsic :: ibits, ior, ishft
